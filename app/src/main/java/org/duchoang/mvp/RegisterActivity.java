...
import org.duchoang.mvp.constract.IRegisterConstract;
import org.duchoang.mvp.constract.RegisterPresenter;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) || TextUtils.isEmpty(username) || TextUtils.isEmpty(password) || TextUtils.isEmpty(confirmPassword)) {
                    ...
                    mPresenter.register(email, username, password, confirmPassword);
                }
            }
        });
    }
